...
<body>
    ...
    <div class="container">
        ...
        <div class="row m-auto">
            ...
            <div class="col-12 col-md-2 my-3">
                <label class="form-label" for="yoil">진료요일 선택</label>
                <select class="form-select" name="yoil" id="yoil">
                    <option value="">전체</option>
            ...
            <div class="col-12 col-md-5 my-3">
                <label class="form-label" for="pharmacyName">상호명</label>
                <input class="form-control" id="pharmacyName" name="pharmacyName" type="text" value="">
            </div>
    ...
    <script src="/javascripts/pharmacy.js"></script>
