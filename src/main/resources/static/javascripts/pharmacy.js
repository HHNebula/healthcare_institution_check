...
function search() {
    ...
    data.set('yoil', document.getElementById("yoil").value);
    data.set('pharmacyName', document.getElementById("pharmacyName").value);
...
pharmacyNameInput.addEventListener("keydown", function (event) {
    if (event.key === "Enter") {
        search();
    }
});
